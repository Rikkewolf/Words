...
function setup() {
	...
	textFont(myfont2);
	textLeading(25);
	text('It can be quite the math problem to figure out what is a reasonable price for your expressions.  Our calculations made by our patented algorithm and based on data gathered from a big range of online platforms. As such the algorithm relies on a long list of parameters. Some of which are changes in trends, frequent use, subject matter, context, intent, influence, body language, identity of [Redacted], trademarks, semiotics, the [Redacted] market, coherence, intended recipient, semantics, Jeff [Redacted] mood, whether it has been used in [Redacted], cohesion, vocabulary, [Redacted] opinions, the current [Redacted] climate.', width*0.25-250, 1500, 300);
	textAlign(CENTER);
